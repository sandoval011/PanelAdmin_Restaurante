...
urlpatterns = [
    ...
    path('reservas/nom_cliente/<int:nom_cliente>/estado/<str:estado>/', ReservaListCreateView.as_view(), name='reserva-list-by-nom_cliente-and-estado'),
    ...
    path('galerias/tipo/<str:tipo>/', GaleriaListCreateView.as_view(), name='galeria-list-create-tipo'),
